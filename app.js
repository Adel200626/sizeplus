...
function loadProducts() {
    ...
    document.getElementById('productsGrid').innerHTML =
        ...
        '<div style="font-size:14px">Chargement des articles...</div></div>';
...
function loadFromSheet() {
    ...
    fetch(GAS_URL + '?t=' + Date.now())
        ...
        .then(function(articles) {
            ...
            promoProducts = (articles && articles.length > 0) ? articles : ARTICLES_SECOURS;
            renderProducts(promoProducts);
            buildFilters();
        })
        .catch(function() {
